...
Wraps the [`proxectonos/Nos_ASR-wav2vec2-large-xlsr-53-gl-with-lm`](https://huggingface.co/proxectonos/Nos_ASR-wav2vec2-large-xlsr-53-gl-with-lm) model from the Proxecto Nós (CiTIUS / USC) with a small Flask + Gunicorn server.
